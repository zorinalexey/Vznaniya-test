...
состава ОС. Попробуйте установить пакет LSB и переустановить КриптоПро CSP.
...
или на портал техподдержки: https://support.cryptopro.ru"
	...
	SUCCESS_install="Пакеты КриптоПро CSP успешно установлены"
...
read documentation or visit support: https://support.cryptopro.ru"
	...
	SUCCESS_install="CryptoPro CSP packages have been successfully installed"
